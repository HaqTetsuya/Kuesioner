    ...
    <?php echo form_open('dashboard/pertanyaan/simpan'); ?>
      ...
      <div class="mb-4">
        ...
        <div class="form-check form-check-inline">
          <input class="form-check-input" type="radio" name="tipe" id="tipe_likert" value="likert" checked>
          <label class="form-check-label" for="tipe_likert">Likert</label>
        </div>
        <div class="form-check form-check-inline">
          <input class="form-check-input" type="radio" name="tipe" id="tipe_text" value="text">
